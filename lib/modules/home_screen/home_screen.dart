      ...
      builder: (context,state){
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text('StockY'.toUpperCase(),style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600,color: Colors.white.withOpacity(0.9)),),
            elevation: 0.0,
            actions: [
              Padding(
                    ...
                    child: ConditionalBuilder(
                      ...
                      builder: (context)=>CarouselSlider(
                        items: StockCubit.get(context).mostGainerData!.data
                            ...
                            child: Row(children: [
                              Text('${item.symbol}',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600,color: Colors.white), ),
                              SizedBox(width: 5,),
                              Text('${item.price}',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w600,color: Colors.white),),
                              SizedBox(width: 5,),
